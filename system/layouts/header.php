					 ...
					 <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						 <div class="menu_section">
							 ...
							 <ul class="nav side-menu">
								 <li><a><i class="fa fa-list"></i> Inventario <span class="fa fa-chevron-down"></span></a>
								 ...
								 <li><a><i class="fa fa-retweet"></i> Devoluciones <span class="fa fa-chevron-down"></span></a>
									 <ul class="nav child_menu">
										 <li><a href="addReturn.php">Agregar devolucion</a></li>
										 <li><a href="returns.php">Gestionar devoluciones</a></li>
									 </ul>
								 </li>
								 <li><a><i class="fa fa-file"></i> Cotizaciones <span class="fa fa-chevron-down"></span></a>
									 <ul class="nav child_menu">

    ...
    <form class="form-horizontal" method="POST" action="php_action/createOutlay.php" id="createOutlayForm">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control" id="outlayDate" name="outlayDate" autocomplete="off"
        ...
        <div class="form-group col-sm-12">
          ...
          <div class="col-sm-7">
            <input type="text" class="form-control" id="provider" name="provider" placeholder="Comprado a"
              autocomplete="off" onchange="success()" />
          </div>
          <div class="col-sm-2">
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#searchProvider"> <i
      ...
      <div class="form-group submitButtonFooter">
        <div class="col-sm-offset-2 col-sm-10">
          ...
          <button type="submit" class="btn btn-primary" id="createOutlay" data-loading-text="Loading..."

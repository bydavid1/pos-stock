        ...
        console.log(code, type);
          ...
          console.log(response);
					if(response.success == true){
						...
						$("#rate"+row).val(response.message2);
						$("#rateValue"+row).val(response.message2);
						$("#quantity"+row).prop('disabled', false);
						$("#rate"+row).prop('disabled', false);

						$("#rate"+row).on("dblclick", function() {
            $("#prices").modal("show");
            $("#prices-success").html('<div class="radio">'+
                  '<label><input type="radio" name="rate[]">$'+response.message2+'</label>'+
                     '</div>'+
                     '<div class="radio">'+
                    '<label><input type="radio" name="rate[]">$Option 2</label>'+
                  '</div>'+
                  '<div class="radio">'+
                    '<label><input type="radio" name="rate[]">$Option 3</label>'+
                  '</div>')
            });
					}else{
						$("#productName"+row).val("");

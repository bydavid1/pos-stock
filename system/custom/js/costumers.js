...
function load(page){
    ...
    $("#loader").fadeIn('slow');
    $.ajax({
        url:'./php_action/manageCostumers.php?action=ajax&page='+page+'&q='+q,
...
$.ajax({
type: "GET",
url: "./php_action/manageCostumers.php",
data: "id="+id,"q":q,
 beforeSend: function(objeto){
     console.log(id);
...
$.ajax({
    type: "POST",
    url: "php_action/addCostumer.php",
    data: parametros,
     beforeSend: function(objeto){
...
$.ajax({
    type: "POST",
    url: "php_action/editCostumer.php",
    data: parametros,
     beforeSend: function(objeto){

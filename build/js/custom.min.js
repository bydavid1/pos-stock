! function(i, e) {
    jQuery.fn[e] = function(i) {
        return i ? this.bind("resize", (t = i, function() {
            var i = this,
                e = arguments;
            s ? clearTimeout(s) : n && t.apply(i, e), s = setTimeout(function() {
                n || t.apply(i, e), s = null
            }, a || 100)
        })) : this.trigger(e);
        var t, a, n, s
    }
...
function init_sidebar() {
    var i = function() {
        ...
        var i = $BODY.outerHeight(),
            e = $BODY.hasClass("footer_fixed") ? -10 : $FOOTER.height(),
            t = $LEFT_COL.eq(1).height() + $SIDEBAR_FOOTER.height(),
            a = i < t ? t : i;
        a -= $NAV_MENU.height() + e, $RIGHT_COL.css("min-height", a)
    };
    ...
    $SIDEBAR_MENU.find('a[href="' + CURRENT_URL + '"]').parent("li").addClass("current-page"), $SIDEBAR_MENU.find("a").filter(function() {
        ...
        i()
    }), i(), $.fn.mCustomScrollbar && $(".menu_fixed").mCustomScrollbar({
        autoHideScrollbar: !0,
        theme: "minimal",
        mouseWheel: {
            preventDefault: !0
